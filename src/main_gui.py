...
# # )
# # from PyQt6.QtGui import QIcon, QPixmap, QFont # QFont is already here!
...
# #         if not QFontDatabase.hasFont("Roboto"): # You might need QFontDatabase for this
# #             font.setFamily("Sans Serif") 

# #     font.setPointSize(10) # Adjust font size as needed
# #     app.setFont(font)

# #     # If you want to use QFontDatabase.hasFont, import it:
